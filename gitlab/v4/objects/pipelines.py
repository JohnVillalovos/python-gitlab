...
class ProjectPipelineManager(RetrieveMixin, CreateMixin, DeleteMixin, RESTManager):
    ...
    _create_attrs = RequiredOptional(required=("ref",), optional=tuple())
...
class ProjectPipelineScheduleVariableManager(
    ...
    _create_attrs = RequiredOptional(required=("key", "value"), optional=tuple())
    _update_attrs = RequiredOptional(required=("key", "value"), optional=tuple())
